      ...
      {section === "business-profile" ? (
        <section className="bg-white rounded-xl border border-[#E2E8F0] overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
            ...
            <button
              className="px-4 py-2 bg-primary text-on-primary rounded-lg text-sm font-semibold hover:opacity-90 active:scale-95 transition-all"
              onClick={() => setLastAction("Business profile saved")}
              type="button"
            >
              Save Changes
            </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  type="text"
                  defaultValue="Metro Wholesale &amp; Logistics"
                />
              </div>
              <div className="space-y-1.5">
                <label className="text-label-caps font-label-caps text-on-surface-variant uppercase">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  className="w-full px-4 py-2.5 rounded-lg border border-[#E2E8F0] focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-body-md"
                  type="email"
                  defaultValue="alex@metrowholesale.com"
                />
              </div>
              <div className="space-y-1.5 md:col-span-2">
                ...
                <textarea
                  ...
                  rows={3}
                  defaultValue="402 Industrial Pkwy, Suite 100, North Austin, TX 78758"
                ></textarea>
              </div>
              <div className="space-y-1.5">
                <label className="text-label-caps font-label-caps text-on-surface-variant uppercase">
              ...
              <div className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(event) => {
                    ...
                    setLastAction(
                      `Tax calculation ${event.target.checked ? "enabled" : "disabled"}`,
                    );
                  }}
                  type="checkbox"
                />
              ...
              <div className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(event) => {
                    ...
                    setLastAction(
                      `Low stock alerts ${event.target.checked ? "enabled" : "disabled"}`,
                    );
                  }}
                  type="checkbox"
                />
              ...
              <div className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(event) => {
                    ...
                    setLastAction(
                      `Barcode system ${event.target.checked ? "enabled" : "disabled"}`,
                    );
                  }}
                  type="checkbox"
                />
                ...
                <tr className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <button
                      ...
                      onClick={() => setLastAction("User action menu opened")}
                      type="button"
                    >
              ...
              <div className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(event) => {
                    ...
                    setLastAction(
                      `Payment reminders ${event.target.checked ? "enabled" : "disabled"}`,
                    );
                  }}
                  type="checkbox"
                />
              ...
              <div className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(event) => {
                    ...
                    setLastAction(
                      `WhatsApp updates ${event.target.checked ? "enabled" : "disabled"}`,
                    );
                  }}
                  type="checkbox"
                />
        ...
        <section className="bg-white rounded-xl border border-[#E2E8F0] p-6 max-w-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              onClick={() => setLastAction("WhatsApp integration opened")}
              type="button"
            >
            ...
            <button
              className="p-4 border border-slate-100 rounded-xl hover:border-blue-200 hover:bg-blue-50/20 transition-all cursor-pointer group text-left"
              onClick={() => setLastAction("Stripe integration opened")}
              type="button"
            >
              <div className="flex items-center justify-between mb-3">
